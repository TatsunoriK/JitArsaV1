      ...
      >
        ...
        <div className="flex items-center gap-2 mb-3">
          <img
            src="/IMG_5528.PNG"
            alt="bot"
            className="w-12 h-12 rounded-full object-cover border-2 border-[#ACB1D6]/40"
          />
          <h4 className="text-sm font-semibold" style={{ color: "#185fa5" }}>
            Nop Napha
          </h4>
        </div>
        ...
        <button
          ...
          className="px-4 py-2 text-xs font-medium transition-all duration-150 active:scale-95 mb-4"
          style={{
            borderRadius: "20px",
          ...
          {loadingHistory ? (
            ...
            grouped.map(([label, chats]) => (
              <div key={label} className="mb-3">
                <p
                  className="text-[10px] font-semibold px-2 mb-1 uppercase tracking-widest"
                  style={{ color: "#9ca3af" }}
                >
                  {label}
                </p>
                      ...
                      {isConfirming ? (
                        ...
                        >
                          <p
                            ...
                            style={{ color: "#374151", borderRadius: "20px" }}
                          >
                          ...
                          <div className="flex gap-1.5">
                            <button
                              ...
                              className="flex-1 py-1.5 rounded-full text-[11px] font-semibold transition"
                              style={{
                                borderRadius: "20px",
                                background: "#a32d2d",
                                color: "#fff",
                            ...
                            <button
                              ...
                              className="flex-1 py-1 rounded-full text-[11px] font-medium transition hover:opacity-80"
                              style={{
                                borderRadius: "20px",
                        ...
                        <Link
                          to={`/chat/${chat._id}`}
                          className="flex items-center gap-2 px-3 py-2 rounded-xl text-xs transition-all no-underline group"
                          style={{
                            borderRadius: "20px",
                            color: isActive ? "#185fa5" : "#4a5568",
                            textDecoration: "none",
                            background: isActive
                              ? "rgba(130,148,196,0.18)"
                        ...
                        >
                          <i
                            className={`bi bi-chat-text text-xs flex-shrink-0 ${isActive ? "text-[#185fa5]" : "opacity-30 group-hover:opacity-60"}`}
                          ></i>
                          ...
                          <button
                            ...
                            className="delete-btn flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full transition-all"
                            title="ลบการสนทนานี้"
                            style={{
                              borderRadius: "20px",
                              color: "#a32d2d",
          ...
          {token ? (
            <>
              ...
              <div
                ...
                style={{borderRadius: "20px", background: "rgba(24,95,165,0.08)" }}
              >
                <div
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm transition-all duration-150 hover:opacity-90 active:scale-95"
                style={{
                  borderRadius: "20px",
                  color: "#a32d2d",
                  background: "rgba(163,45,45,0.08)",
            ...
            <Link
              to="/login"
              className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-sm transition-all duration-150 hover:opacity-90 no-underline"
              style={{
